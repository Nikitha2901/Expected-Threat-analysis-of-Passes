...
from classes.visual import DistributionPlot,PassContributionPlot_Logistic,PassVisual,PassContributionPlot_Xnn,xnn_plot,PassContributionPlot_Logistic_event,PassContributionPlot_Logistic_pressure,PassContributionPlot_Logistic_speed,Distributionplot_xnn_models,model_contribution_xnn,PassContributionPlot_Logistic_position
from classes.description import PassDescription_logistic,PassDescription_xNN
from classes.data_source import Passes
from classes.description import PassDescription_logistic,PassDescription_xNN
...
# Define the tabs
tab1, tab2 = st.tabs(["Logistic Regression", "xNN"])
